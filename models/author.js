...
class Author extends Sequelize.Model{
        ...
        return super.init(
            {
              ...
              },
              {
                // 두번째 객체 인수는 테이블 자체에 대한 설정
                    ...
                    modelName: 'Author', /* 모델 이름을 설정. */
                    tableName: 'Authors', /* 데이터베이스의 테이블 이름. */
   ...
   static associate(db) {
      db.Author.hasMany(db.Topic, { foreignKey: 'author_id', sourceKey: 'id', onDelete: 'cascade', onUpdate: 'cascade' });
   }
}
